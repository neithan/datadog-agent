...
func InitConfig(config Config) {
	...
	config.BindEnvAndSetDefault("admission_controller.auto_instru.enabled", true)
	config.BindEnvAndSetDefault("admission_controller.auto_instru.endpoint", "/injectlib")
	config.BindEnvAndSetDefault("admission_controller.auto_instru.container_registry", "gcr.io/datadoghq")
